...
export default function DashboardPage() {
  ...
  <Card className="bg-gradient-to-tr from-cobalt to-pacific-blue p-3 sm:p-4">
    ...
    <CardContent>
      <div className="text-base sm:text-lg lg:text-2xl font-bold text-white">R4,500</div>
  ...
  <Card className="bg-gradient-to-tr from-sapphire to-dark-turquoise p-3 sm:p-4">
    ...
    <CardContent>
      <div className="text-base sm:text-lg lg:text-2xl font-bold text-white">28</div>
  ...
  <Card className="bg-gradient-to-tr from-pacific-blue to-dark-turquoise p-3 sm:p-4">
    ...
    <CardContent>
      <div className="text-base sm:text-lg lg:text-2xl font-bold text-white">5</div>
  ...
  <Card className="bg-gradient-to-tr from-medium-purple to-sapphire p-3 sm:p-4">
    ...
    <CardContent>
      <div className="text-base sm:text-lg lg:text-2xl font-bold text-white">4.8 ★</div>
      <p className="text-xs text-dark-turquoise">Based on 23 reviews</p>
    </CardContent>
  </Card>
</div>
